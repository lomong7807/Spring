...
public class MainController {
	...
	public String index(Model model) {
		...
		// 생성자를 이용한 초기화
		User1DTO user1 = new User1DTO("A102", "김츤추", "010-1234-1002", 30);
		...
		users.add(new User1DTO("A103", "장보고", "010-1111-1003", 45));
		users.add(new User1DTO("A104", "강감찬", "010-1111-1004", 55));
		users.add(new User1DTO("A105", "이순신", "010-1111-1005", 65));
